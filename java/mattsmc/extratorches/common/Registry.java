...
import mattsmc.extratorches.block.InvisLightBlock;
...
public class Registry {
	...
	public static void loadItems() {
		...
		invisBlock = new InvisLightBlock();
		...
		// Blocks
		RegisterHelper.registerBlock(invisBlock);
		...
		GameRegistry.registerTileEntity(TileInvisLightBlock.class, "InvisLightBlock");
